...
public class InterThreadCom {
	...
	public static void main(String[] args) {
		...
		HashMap <Project1,ArrayList <Employee>> hMap1 = new HashMap<>();
		HashMap <Project1,ArrayList <Employee>> hMap2 = new HashMap<>();
		HashMap <Project1,ArrayList <Employee>> hMap3 = new HashMap<>();
		...
		eList6.add(e11);
		eList6.add(e12);
		Project1 project1 = new Project1("P1","Music Synthesizer",23);
		Project1 project2 = new Project1("P2","Vehicle Movement Tracker",13);
		Project1 project3 = new Project1("P3","Liquid Viscosity Finder",15);
		Project1 project4 = new Project1("P4","InsuranceTool",23);
		Project1 project5 = new Project1("P5","BankingTool",13);
		Project1 project6 = new Project1("P6","PayrollTool",15);
